...
public class ItemBuilder {
    ...
    /**
     * Initalizes the ItemBuilder with an already existing {@link com.yakovliam.spaceapi.util.ItemBuilder}
     *
    ...
    public ItemBuilder lore(List<String> lore) {
        ...
        this.lore = andSymbol ? lore.stream().map(s -> ChatColor.translateAlternateColorCodes('&', s)).collect(Collectors.toList()) :  lore;
        return this;
    }
